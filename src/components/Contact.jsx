...
const Contact = () => {
  ...
  return (
    <section id="contact" className="p-12 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <div className="flex justify-center mt-6">
        <form onSubmit={handleSubmit} className="w-full max-w-4xl space-y-4">
          {isSubmitted && <p className="text-green-500 dark:text-green-400 text-center mb-4">Message sent successfully!</p>}
